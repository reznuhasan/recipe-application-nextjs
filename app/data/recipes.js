 const recipes=[
  ...
  },
  {
      ...
      description: "Breakfast is the most important meal of the day, and this blog is packed with recipes that will help you start your day right. From healthy smoothie bowls to classic pancakes, waffles, and omelets, there\u2019s something here for everyone. Whether you\u2019re in a rush and need a quick grab-and-go option or you\u2019re planning a leisurely weekend brunch, these recipes will inspire you to make breakfast more enjoyable and nutritious.",
  ...
  },
  {
      ...
      description: "Waffles are a breakfast favorite that can be sweet, savory, or both! This blog explores the best waffle recipes for every taste, from classic Belgian waffles with maple syrup to savory options like cheddar and herb waffles. Whether you're making them for brunch or dessert, these recipes are sure to please. Learn how to perfect your waffle batter and master the art of creating the perfect crispy-on-the-outside, fluffy-on-the-inside waffle.",
  ...
  },
  {
      ...
      description: "Dips are the ultimate party food, and they're also great for snacking or adding a little extra flavor to your meals. In this blog, we cover a range of delicious and easy-to-make dips, from classic guacamole and hummus to more unique options like buffalo chicken dip and roasted red pepper spread. Perfect for pairing with chips, veggies, or bread, these dips are a must for your next gathering or movie night.",
  ...
  },
  {
      ...
      description: "There's nothing quite like a bowl of warm, comforting soup. Whether you're battling a cold or just in need of a cozy meal, soup always does the trick. This blog features a collection of hearty and healthy soups that are easy to make and full of flavor. From classic chicken noodle soup to creamy tomato bisque, you'll find something to satisfy your cravings. These recipes are perfect for meal prep, and most can be made in under 30 minutes. So grab a spoon and dive into these comforting bowls of goodness!",
  ...
  },
  {
      ...
      description: "Chicken is one of the most versatile and popular proteins in the world. Whether you're roasting a whole bird, frying up some wings, or grilling a marinated breast, there's a chicken recipe for every taste and occasion. In this blog, we explore some of the best chicken recipes that are easy to make and packed with flavor. From spicy buffalo wings to creamy chicken alfredo, you'll never run out of delicious chicken ideas.",
  ...
  },
  {
      ...
      description: "Pastries are the epitome of indulgence, whether you're enjoying a buttery croissant for breakfast or a sweet danish for dessert. In this blog, we'll explore a variety of pastry recipes that you can easily make at home. From flaky puff pastries to rich cream-filled eclairs, you'll find something to satisfy your sweet tooth. Learn the techniques for perfecting dough, working with fillings, and creating stunning pastries that will impress your friends and family.",
